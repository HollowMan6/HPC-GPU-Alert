...
In the hope of doing labeling automatically, we also did the silhouette analysis of K-means clustering directly on the collected GPU monitoring data of Mahti, which starts from December 2023, and ends in May 2024, as shown in Figure \ref{fig_silhouette_directly}, as well as features generated with statistical aggregation, as shown in Figure \ref{fig_silhouette_statistics}. Each color in the figure represents a cluster. The red vertical line denotes the average silhouette coefficient value across all clusters. More explanation of silhouette analysis can be found in Subsection \ref{subsec:silhouette}. The result shows that neither of the methods works well since most clusters have the majority proportion of negative coefficient value, and they cannot be reasonable classifications. 

\begin{figure}[H]
    \centering
        \subfloat[n\_clusters = 2]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_directly_2.pdf}
    }
        \subfloat[n\_clusters = 3]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_directly_3.pdf}
    }\\
        \subfloat[n\_clusters = 4]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_directly_4.pdf}
    }
        \subfloat[n\_clusters = 5]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_directly_5.pdf}
    }\\
        \subfloat[n\_clusters = 6]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_directly_6.pdf}
    }
        \subfloat[n\_clusters = 7]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_directly_7.pdf}
    }\\
...
\begin{figure}[H]
    \centering
        \subfloat[n\_clusters = 2]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_statistics_2.pdf}
    }
        \subfloat[n\_clusters = 3]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_statistics_3.pdf}
    }\\
        \subfloat[n\_clusters = 4]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_statistics_4.pdf}
    }
        \subfloat[n\_clusters = 5]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_statistics_5.pdf}
    }\\
        \subfloat[n\_clusters = 6]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_statistics_6.pdf}
    }
        \subfloat[n\_clusters = 7]{
        \includegraphics[width=0.4\textwidth]{figures/silhouette/silhouette_statistics_7.pdf}
    }

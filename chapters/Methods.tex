...
BEGIN
  PERFORM pg_notify('gpu_usage_insertion', (NEW.host || ',' || NEW.gpu || ',' || NEW.job || ',' || NEW.username || ',' || NEW.load_gpu || ',' || NEW.load_memory || ',' || NEW.used_mem || ',' || NEW.power || ',' || NEW.temperature)::text);
  RETURN NEW;
END;
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/usage-graph.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/usage-accessibility-graph.png}
...
\begin{figure}[H]
    \centering
        ...
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_directly_2.pdf}
    }
        \subfloat[n\_clusters = 3]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_directly_3.pdf}
    }\\
        \subfloat[n\_clusters = 35]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_directly_4.pdf}
    }
        \subfloat[n\_clusters = 5]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_directly_5.pdf}
    }\\
        \subfloat[n\_clusters = 6]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_directly_6.pdf}
    }
        \subfloat[n\_clusters = 7]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_directly_7.pdf}
    }\\
...
\begin{figure}[H]
    \centering
        \subfloat[n\_clusters = 2]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_statistics_2.pdf}
    }
        \subfloat[n\_clusters = 3]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_statistics_3.pdf}
    }\\
        \subfloat[n\_clusters = 4]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_statistics_4.pdf}
    }
        \subfloat[n\_clusters = 5]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_statistics_5.pdf}
    }\\
        \subfloat[n\_clusters = 6]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_statistics_6.pdf}
    }
        \subfloat[n\_clusters = 7]{
        \includegraphics[width=0.35\textwidth]{figures/silhouette/silhouette_statistics_7.pdf}
    }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/sliding-window.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/fixed-sliding-window.pdf}
